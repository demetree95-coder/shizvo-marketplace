...
async function seed() {
  ...
  const products = [
    { name: "iPhone 15 Pro", slug: "iphone-15-pro", price: 3499, discountPrice: 3199, stock: 15, images: '["https://picsum.photos/seed/iphone15/800/800"]', features: '["A17 Pro ჩიპი", "48MP კამერა", "256GB მეხსიერება", "6.7\" OLED ეკრანი"]', catId: "cat-electronics" },
    { name: "Samsung Galaxy S24", slug: "samsung-galaxy-s24", price: 2499, discountPrice: null, stock: 20, images: '["https://picsum.photos/seed/galaxys24/800/800"]', features: '["Snapdragon 8 Gen 3", "50MP კამერა", "128GB მეხსიერება", "6.2\" Dynamic AMOLED"]', catId: "cat-electronics" },
    { name: "MacBook Air M3", slug: "macbook-air-m3", price: 4999, discountPrice: 4599, stock: 8, images: '["https://picsum.photos/seed/macbookm3/800/800"]', features: '["Apple M3 ჩიპი", "16GB RAM", "512GB SSD", "15.3\" Liquid Retina"]', catId: "cat-electronics" },
    { name: "AirPods Pro 2", slug: "airpods-pro-2", price: 799, discountPrice: 699, stock: 30, images: '["https://picsum.photos/seed/airpods/800/800"]', features: '["Active Noise Cancellation", "Adaptive Audio", "USB-C", "6 საათი მუშაობა"]', catId: "cat-electronics" },
    { name: "კაბა ყავისფერი", slug: "kaba-qavisteri", price: 149, discountPrice: 99, stock: 25, images: '["https://picsum.photos/seed/dress1/800/800"]', features: '["100% ბამბა", "M-XL ზომები", "საზაფხულო", "ნატურალური ფერი"]', catId: "cat-clothing" },
    { name: "ჯინსი რომაული", slug: "jinsi-romauli", price: 199, discountPrice: null, stock: 18, images: '["https://picsum.photos/seed/jeans1/800/800"]', features: '["Stretch დენიმი", "რეგულარული fit", "ღილებიანი", "სქელი ქსოვილი"]', catId: "cat-clothing" },
    { name: "ეკო-ჩანთა", slug: "eko-chanta", price: 49, discountPrice: 39, stock: 50, images: '["https://picsum.photos/seed/ecobag/800/800"]', features: '["100% ორგანული ბამბა", "დიდი მოცულობა", "მრავალფერი", "30x40 სმ"]', catId: "cat-clothing" },
    { name: "სამზარეულოს კომპლექტი", slug: "samzareulos-komplekti", price: 89, discountPrice: null, stock: 12, images: '["https://picsum.photos/seed/kitchen1/800/800"]', features: '["უჟანგავი ფოლადი", "10 ცალი", "ტეფლონის საფარი", "ინდუქციისთვის"]', catId: "cat-home" },
    { name: "LED ჭკვიანი ნათურა", slug: "led-chkviani-natura", price: 59, discountPrice: 45, stock: 40, images: '["https://picsum.photos/seed/ledlight/800/800"]', features: '["WiFi", "16 მილიონი ფერი", "Alexa/Google", "დისტანციური მართვა"]', catId: "cat-home" },
    { name: "სახის კრემი", slug: "saxis-kremi", price: 35, discountPrice: null, stock: 45, images: '["https://picsum.photos/seed/cream1/800/800"]', features: '["ჰიალურონის მჟავა", "ვიტამინი C", "50 მლ", "ყველა ტიპის კანისთვის"]', catId: "cat-beauty" },
  ];
